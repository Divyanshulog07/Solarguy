...
import firstImage from "../rigelPlusSeriesImages/firstPart/1st.png";
    ...
    <>
      <div className="lg:flex md:flex lg:-mt-16 md:-mt-[550px] -mt-[360px] lg:px-0 md:px-8 px-10 items-center">
        ...
        <div className="lg:w-1/2 md:w-1/2 w-full mt-4">
          ...
          <h3 className="font-semibold lg:mt-5 md:mt-5 mt-3">
            BIFACIAL MONO PERC
          </h3>
          <h3 className="font-semibold">144 CELLS | From 525 wp to 550 wp</h3>
          ...
          <ul className="list-disc list-inside lg:text-base md:text-base text-sm text-justify">
            <li className="lg:mt-5 md:mt-5 mt-3">
              Upto 30% increase in efficiency.
            </li>
            ...
            <li className="lg:mt-3 md:mt-3 mt-1">1500 V module</li>
            <li className="lg:mt-3 md:mt-3 mt-1">
              Lower temperature co-efficient.
            </li>
            <li className="lg:mt-3 md:mt-3 mt-1">
              Very high power output per sq. meter
            </li>
            <li className="lg:mt-3 md:mt-3 mt-1">
              25 years of linear output power warranty
            </li>
            <li className="lg:mt-3 md:mt-3 mt-1">
