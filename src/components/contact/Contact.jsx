...
import contactNavbarImage from "../contact/contactImages/contactNavbarImage.jpeg";
import { Link } from "react-router-dom";
import FirstPart from "./contactParts/FirstPart";
      ...
      <div id="contact-section">
        ...
        <div className="min-h-screen">
          <img
            ...
            src={contactNavbarImage}
            alt="contactnavbarimage"
            autoPlay
            loop
            muted
          />
