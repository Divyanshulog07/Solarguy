...
import companyProfileNavbarImage from "../company-profile/companyProfileImages/companyProfileNavbarImage.jpg";
...
const CompanyProfile = ({ isDarkMode }) => {
  ...
  return (
    <>
      <div id="companyProfile-section">
        {/* navbar-part  */}
        <div className="min-h-screen">
          <img
            className="top-0 left-0 w-full lg:h-[600px] md:h-[450px] h-[260px] object-cover"
            src={companyProfileNavbarImage}
            alt="companyProfilenavbarimage"
            autoPlay
            loop
            muted
          />
