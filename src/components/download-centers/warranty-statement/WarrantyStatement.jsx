...
import warrantyStatementNavbarImage from "../warranty-statement/warrantyStatementImages/warrantyStatementNavbarImage.jpg";
import { Link } from "react-router-dom";

const WarrantyStatement = ({ isDarkMode }) => {
  ...
  return (
    <>
      <div id="warrantyStatement-section">
        {/* navbar-part  */}
        <div className="min-h-screen">
          <img
            className="top-0 left-0 w-full lg:h-[600px] md:h-[450px] h-[260px] object-cover"
            src={warrantyStatementNavbarImage}
            alt="warrantyStatementnavbarimage"
            autoPlay
            loop
            muted
          />
...
export default WarrantyStatement;
