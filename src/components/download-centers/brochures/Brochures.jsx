...
import brochuresNavbarImage from "../brochures/brochuresImages/brochuresNavbarImage.jpg";
import { Link } from "react-router-dom";

const Brochures = ({ isDarkMode }) => {
